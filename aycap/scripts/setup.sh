...
cd /home
wget -O dependency-check-6.0.3-release.zip https://dl.bintray.com/jeremy-long/owasp/dependency-check-6.0.3-release.zip
unzip dependency-check-6.0.3-release.zip
rm -f dependency-check-6.0.3-release.zip
